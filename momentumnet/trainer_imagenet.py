...
from .models import ResNet18, mResNet18, ResNet34, mResNet34, ResNet101, mResNet101, ResNet152, mResNet152


def main(datapath, saveadr, expe_name, arch, n_workers, n_epochs, batch_size, lr,
         momentum=.9, weight_decay=1e-4, print_freq=100, init_speed=0):
    ...
    for epoch in range(start_epoch, n_epochs):
        ...
        np.save('results/%s/%s.npy' % (expe_name, saveadr), np.array([train_losss, train_top1s, train_top5s,
                                              test_losss, test_top1s, test_top5s]))
